...
@include('partials.nav')
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-black">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Review-Apps</span>
    </a>
...
@include('partials.sidebar')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="https://adminlte.io">Rizki Irawan</a>.</strong> By Sanbercode Bootcamp.
  </footer>
